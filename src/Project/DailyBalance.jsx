									...
									<div className="card-header">
										<div className="row">
											...
											<div className="col-auto">
												<Link to="/invoice-list" className="btn-right btn btn-sm btn-outline-primary">
													View All
												</Link>
											</div>
										</div>
												...
												<tbody>
													{recentinvoices_.map((item, index) => {
														...
														if (item.status === 'Paid') {
															...
															status = <span className="badge bg-info-light text-info">{item.status}</span>

														} else if (item.status === 'Partially Paid') {
															status = <span className="badge bg-warning-light text-warning">{item.status}</span>
								...
								<div className="card">
									<div className="card-header">
										<div className="row">
											...
											<div className="col-auto">
												<Link to="/invoice-details" className="btn-right btn btn-sm btn-outline-primary">
													View All
												</Link>
											</div>
										</div>
